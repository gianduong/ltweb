...
<body>
  ...
  <input class="h" type="text" id="username" placeholder="Nhập họ tên"/>
  <div class="val_error" id="name_error"></div></div><br />
  <div><a>Email*</a><br />
  <input class="h" type="text" id="email" placeholder="Nhập email"/>
   <div class="val_error" id="email_error"></div></div><br />
   <div><a>SĐT*</a><br />
  <input class="h" type="text" id="phone" placeholder="Nhập số điện thoại"/>
   <div class="val_error" id="phone_error"></div></div><br />
   <div><a>Tài khoản</a><br />
  <input class="h" type="text" id="taikhoan" placeholder="Nhập tài khoản" required>
   <div class="val_error" id="taikhoan_error"></div></div><br />
  <div><a>Mật Khẩu</a><br />
  <input class="h" type="text" id="password" placeholder="Nhập mật khẩu"/>
   <div class="val_error" id="password_error"></div></div><br />
  <div><a>Nhập Lại Mật Khẩu</a><br />
  <input class="h" type="text" id="re_password" placeholder="Nhập lại mật khẩu"/>
